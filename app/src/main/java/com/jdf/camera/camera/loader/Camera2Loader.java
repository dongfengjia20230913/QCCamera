...
public class Camera2Loader extends CameraLoader {
    ...
    public int getCameraOrientation() {
        ...
        try {
            ...
            JLog.d(TAG,"display cameraId:"+cameraId+" front:"+getCameraId(CameraCharacteristics.LENS_FACING_FRONT));

            CameraCharacteristics characteristics = mCameraManager.getCameraCharacteristics(cameraId);
            orientation = characteristics.get(CameraCharacteristics.SENSOR_ORIENTATION);
            JLog.d(TAG,"SENSOR_ORIENTATION:"+orientation);

        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
        JLog.d(TAG, "degrees: " + degrees + ", orientation: " + orientation + ", mCameraFacing: " + mCameraFacing);
